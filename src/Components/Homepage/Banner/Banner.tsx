      ...
      <div className="container">
        <div className="banner-inner">
          <div className="banner-content">
            <div className="overflow-hidden">
              <h1
                data-w-id="5740b6fe-714f-2811-d019-37cf4af9de52"
                style={{
                  transform:
            ...
            <div className="overflow-hidden mb-30">
              <h1
                data-w-id="5740b6fe-714f-2811-d019-37cf4af9de57"
                style={{
                  transform:
                    "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg)",
                  transformStyle: "preserve-3d",
                }}
                className="banner-title-departament"
              >
                Department Store.
              </h1>
            </div>
        ...
        <div className="banner-stage-wrap">
          <div
            style={{
              transform:
                "translate3d(0vw, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg)",
              transformStyle: "preserve-3d",
            }}
